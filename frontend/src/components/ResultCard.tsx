...
export const ResultCard: React.FC<ResultCardProps> = ({ result }) => {
  ...
  return (
    ...
    >
      <div className="relative bg-black/40 backdrop-blur-2xl rounded-[2rem] shadow-xl border border-white/10 p-6 md:p-8 overflow-hidden">
...
{/* Horizontal dashboard: Status | Class (row 1), Pie+Legend | Bars (row 2).
            Column 1 keeps the fixed pie+legend width; column 2 takes the rest. */}
        <div className="grid grid-cols-1 md:grid-cols-[450px_1fr] gap-6 gap-y-3 items-start">
